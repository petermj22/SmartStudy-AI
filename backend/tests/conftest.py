...
Shared fixtures for all tests. Moved to backend/tests for professional hardening.
"""
...
# Path(__file__) is project_root/backend/tests/conftest.py
# .parent is project_root/backend/tests/
# .parent.parent is project_root/backend/
